...
## EXPORT OPTIONS
export = True # choose if selcted objects should be exported as gltf files.
export_modifiers = True # if true apply modifiers to exported objects
...
def loop_bake(_type,_interpolation):
    ...
    if active.name + "_" + _type in bpy.data.images:
        _texture = bpy.data.images[active.name + "_" + _type]
        _texture.scale(tex_size[0],tex_size[1])
